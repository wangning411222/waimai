				...
				<view class="_tab-item-box" :class="[defaultConfig.itemWidth ? '_clamp' : '_flex']">
					<block v-for="(item, index) in tabList" :key="index" >
						<view 
							...
							<text style="vertical-align: middle;">{{ item[defaultConfig.key] || item }}</text>
							<image v-if="item[defaultConfig.img]" :src="item[defaultConfig.img]" mode="widthFix" style="width: 35rpx;vertical-align: middle;"></image>
							</view>
					</block>
				</view>
