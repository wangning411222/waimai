	...
	<view>
		<view class="u-flex user-box u-p-l-30 u-p-r-20 u-p-b-30 u-p-t-30" v-if="!isAuthorized">
			...
			<view class="u-m-l-10 u-p-10">
				<button v-if="!isAuthorized" open-type="getUserInfo" @getuserinfo="wxlogin" class="authBtn">同步微信信息</button>
			</view>
		</view>
		<view class="u-flex user-box u-p-l-30 u-p-r-20 u-p-b-30 u-p-t-30" v-if="isAuthorized">
			<view class="u-m-r-20">
			...
			<view class="u-flex-1 text-white">
				<view class="u-font-18 u-p-b-10 text-white">
					{{ userInfo.nick_name }}
					<u-icon size="30" :name="userInfo.sex == 1 ? 'man' : userInfo.sex == 2 ? 'woman' : ''"
						:color="userInfo.sex == 1 ? '#56b4ff' : userInfo.sex == 2 ? '#e599e5' : ''"></u-icon>
				</view>
				<view>uid:{{ userInfo.uid }}</view>
			</view>
			<view class="u-m-l-10 u-p-10" style="text-align: center;">
		...
		<view class="content_box">
			...
			<view class="u-m-t-20 bg-white card" v-if="userInfo.gid && userInfo.gid == 2">
				<view style="padding: 0 0 30rpx; border-bottom: 1rpx solid #f3f3f3; font-weight: bold;">商家服务</view>
				<u-grid :col="4" :border="false">
					...
					<u-grid-item>
						<view class="item-menu-image dot-box" @click="toUserComment()">
							<u-icon name="chat-fill" size="60" color="#6ee4c1" style="vertical-align: middle;"></u-icon>
			...
			<view class="u-m-t-20 bg-white card" v-if="userInfo.gid && userInfo.gid == 20">
				<view style="padding: 0 0 30rpx; border-bottom: 1rpx solid #f3f3f3; font-weight: bold;">分部管理</view>
				<u-grid :col="4" :border="false">
			...
			<view class="u-m-t-20 bg-white card" v-if="userInfo.gid && (userInfo.gid == 4 || userInfo.gid == 6)">
				<view style="padding: 0 0 30rpx; border-bottom: 1rpx solid #f3f3f3; font-weight: bold;">跑腿服务</view>
				<view>
				...
				<u-grid :col="4" :border="false">
					...
					<u-grid-item>
						<view class="item-menu-image" @click="settlement()" style="display: flex;justify-content: center;">
			...
			<view class="u-m-t-20 bg-white card">
				<view style="padding: 0 0 30rpx; border-bottom: 1rpx solid #f3f3f3; font-weight: bold;">我的服务</view>
				<u-grid :col="4" :border="false">
					<u-grid-item>
						<view class="item-menu-image" @click="my_order()">
							<u-icon name="order" size="60" color="#6ee4c1" style="vertical-align: middle;"></u-icon>
						</view>
					...
					<u-grid-item>
						<view class="item-menu-image" @click="my_address()">
							<u-icon name="woshenqingdeicon" custom-prefix="custom-icon" size="60" color="#6ee4c1"></u-icon>
						</view>
						<view class="grid-text">我的地址</view>
					</u-grid-item>
					<u-grid-item>
						<view class="item-menu-image" @click="my_coupon()">
							<u-icon name="coupon" size="60" color="#6ee4c1" style="vertical-align: middle;"></u-icon>
						</view>
			...
			<view class="u-m-t-20 bg-white card" style="padding-bottom: 0;">
				<view style="padding: 0 0 30rpx; border-bottom: 1rpx solid #f3f3f3; font-weight: bold;">其他服务</view>
				<u-grid :col="4" :border="false">
