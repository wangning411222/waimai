<template>
  <view>
    <view
      class="u-flex user-box u-p-l-30 u-p-r-20 u-p-b-30 u-p-t-30"
      v-if="!isAuthorized"
    >
      <view class="u-m-r-10">
    ...
    <view class="content_box">
      <view
        class="u-m-t-20 d-flex bg-white card"
        v-if="userInfo.gid && (userInfo.gid == 0 || userInfo.gid == 2)"
      >
        <view>
          <image
            src="../../static/icon/qiye.png"
            mode=""
        ...
        <view
          class="flex d-flex"
          style="padding-left: 30rpx; align-items: center"
        >
          <view class="flex">
            <view>商家入驻</view>
          ...
          <view>
            <text v-if="company_status == 0" class="join_btn" @click="settled"
              >现在入驻</text
            >
            <text v-if="company_status == 1" class="join_btn" @click="settled2"
              >待审核</text
            >
      ...
      <view
        class="u-m-t-20 bg-white card"
        v-if="userInfo.gid && userInfo.gid == 20"
      >
        <view
          style="
            padding: 0 0 30rpx;
      ...
      <view
        class="u-m-t-20 bg-white card"
        v-if="userInfo.gid && (userInfo.gid == 4 || userInfo.gid == 6)"
      >
        <view
          style="
            padding: 0 0 30rpx;
