<template>
	<view>
		<view class="shop-box">
			<u-search placeholder="请输入商家或商品名称" :disabled="true" v-model="keywordShopName" :action-style="actionStyle"
				@click="companySearch" action-text="搜索" border-color="#ff9900" search-icon-color="#ff9900"
				bg-color="#fff" @custom="companySearch" @search='companySearch' @clear="clear()"></u-search>
			<view class="shop-content">
				...
				<view class="select-box">
					<u-button v-for="(item, index) in selectArr" :key="index" :custom-style="customStyle" plain
						:type="selectIndex == index ? 'warning' : 'default'"
						@click="selecthandle(index)">{{ item.name }}</u-button>
				</view>
