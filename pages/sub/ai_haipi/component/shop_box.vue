<template>
	<view class="shop-box">
		...
		<view style="overflow: hidden; padding-left: 20rpx;" v-if="goodsObj['goods_list'] && goodsObj['goods_list'].length > 0">
			<view style="width: 229rpx; float: left; padding-right: 20rpx;" v-for="(it,ins) in goodsObj['goods_list']" :key="ins">
