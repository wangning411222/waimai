	...
	<view class="padding-30 margin-center padding-bottom-150">
		...
		<view v-if="deliverWayCurrent == 0">
			...
			<view v-if="Object.keys(address_detail).length > 0"
				...
				<view class="margin-top-10 padding-left-50">{{ address_detail.real_name }} {{ address_detail.phone }}
				</view>
		...
		<view v-if="deliverWayCurrent == 1">
			<view
				class="bg-color-white padding-left-20 padding-right-20 padding-top-50 padding-bottom-50 border-radius-15">
		...
		<view class="bg-color-white padding-20 border-radius-15 margin-top-20">
			...
			<view>
				<view @tap="couponClick" class="u-cell u-border-bottom u-col-center"
		...
		<view class="bg-color-white padding-20 border-radius-15 margin-top-20 font30">
			<view class="d-row d-jc-between padding-top-20 padding-bottom-30"
