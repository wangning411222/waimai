	...
	<view class="content_box">
		...
		<u-form :model="form" ref="uForm" :border-bottom="false">
			...
			<view class="card-list">
				<u-upload :action="upimgUrl" :file-list="fileBannerList" ref="uUpBannerimg" width="160" height="160" multiple='false' upload-text="商品图" max-count="1"></u-upload>
			</view>
			<view class="card-list">
			...
			<view class="card-list" style="padding: 35rpx 25rpx; display: none;">
				<view>
					<u-upload :action="upimgUrl" :file-list="fileDescList" ref="uUpDescimg" width="160" height="160" multiple='false' upload-text="商品详情图"></u-upload>
				</view>
			</view>
...
export default {
	...
	methods: {
		formatData(){
			...
			_this.$store.dispatch('user/goodsRead',{'goods_id':this.model.goods_id}).then((res) => {
				if(res.code == 0) {
