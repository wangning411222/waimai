<template>
  <view class="content_box">
    <u-form :model="form" ref="uForm" :border-bottom="false">
      ...
      >
        <view
          v-for="(item, index) in skuNopriceArr"
          :key="index"
          class="sku-noprice-arr"
        >
          <view
            class="d-flex"
            style="padding: 0 0 15rpx; justify-content: space-between"
          >
            <view class="flex" style="color: #fa3534; font-weight: bold">{{
              item.skuType
            }}</view>
            <view
              class="flex"
