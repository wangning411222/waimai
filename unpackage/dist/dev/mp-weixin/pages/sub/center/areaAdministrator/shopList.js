...
try {
  components = {
    ...
    kevyLoading: function () {
      return __webpack_require__.e(/*! import() | components/kevy-loading/kevy-loading */ "components/kevy-loading/kevy-loading").then(__webpack_require__.bind(null, /*! @/components/kevy-loading/kevy-loading.vue */ 940))
    },
  }
} catch (e) {
  if (
...
var shopBox = function shopBox() {
  __webpack_require__.e(/*! require.ensure | pages/sub/center/components/areaAd_shop_box */ "pages/sub/center/components/areaAd_shop_box").then((function () {
    return resolve(__webpack_require__(/*! @/pages/sub/center/components/areaAd_shop_box.vue */ 947));
...
var kevyLoading = function kevyLoading() {
  __webpack_require__.e(/*! require.ensure | components/kevy-loading/kevy-loading */ "components/kevy-loading/kevy-loading").then((function () {
    return resolve(__webpack_require__(/*! @/components/kevy-loading/kevy-loading */ 940));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
var _default = {
  components: {
